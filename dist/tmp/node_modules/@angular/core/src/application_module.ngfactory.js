...
var import12 = require('@angular/core/src/console');
var import13 = require('@angular/core/src/error_handler');
...
var ApplicationModuleInjector = (function (_super) {
    ...
    ApplicationModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__2 = new import3.ApplicationRef_(this.parent.get(import9.NgZone), this.parent.get(import12.Console), this, this.parent.get(import13.ErrorHandler), this, this._ApplicationInitStatus_1, this.parent.get(import14.TestabilityRegistry, null), this.parent.get(import14.Testability, null));
    ...
    ApplicationModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import15.IterableDiffers)) {
            return this._IterableDiffers_8;
        }
        if ((token === import16.KeyValueDiffers)) {
